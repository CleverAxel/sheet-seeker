...
import { ExcelSearch } from "@/tabs/excelSearch/ExcelSearch";
import { ExcelFileHandler } from "@/tabs/excelFileHandler/ExcelFileHandler";
import { IExcelFileHandlerRef } from "@/tabs/excelFileHandler/types";
import { SupportedBrowsers } from "@/tabs/SupportedBrowsers";
...
function App() {
    ...
    let fileComponentRef: IExcelFileHandlerRef | undefined;
        ...
        <>
            ...
            <main class="grow">
                ...
                <div hidden={selectTab() != EnumTab.fileHandler}>
                    <ExcelFileHandler ref={fileComponentRef}></ExcelFileHandler>
                </div>
                <div hidden={selectTab() != EnumTab.searchSheets}>
                    <ExcelSearch callbackGetFiles={getFiles}></ExcelSearch>
                </div>
