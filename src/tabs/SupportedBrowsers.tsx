    ...
    return (
        <div class="max-w-5xl mx-auto mt-5 p-3">
            ...
            <ul class="pl-4 list-disc">
                ...
                <li>Edge 80 (Sorti le : 2020-02-07)</li>
                <li>Firefox 114 (Sorti le : 2023-06-06) </li>
                <li>Opera 67 (Sorti le : 2020-03-03) </li>
                <li>Safari 15 (Sorti le : 2021-09-20) </li>
            </ul>
            <ul class="pl-4 mt-5 list-disc">
                <li>Chrome Android 80 (Sorti le : 2020-02-04) </li>
                <li>Firefox for Android 114 (Sorti le : 2023-06-06) </li>
